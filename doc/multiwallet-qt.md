...
In order to support loading of multiple wallets in cts-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cts.cpp.
...
Changes to cts.cpp
----------------------
cts.cpp is the entry point into cts-qt, and as such, will require some minor modifications to provide hooks for
