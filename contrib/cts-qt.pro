...
RESOURCES += src/qt/cts.qrc src/qt/cts_locale.qrc

TRANSLATIONS += src/qt/locale/cts_bg.ts \
                src/qt/locale/cts_de.ts \
                src/qt/locale/cts_en.ts \
                src/qt/locale/cts_es.ts \
                src/qt/locale/cts_fi.ts \
                src/qt/locale/cts_fr.ts \
                src/qt/locale/cts_it.ts \
                src/qt/locale/cts_ja.ts \
                src/qt/locale/cts_pl.ts \
                src/qt/locale/cts_pt.ts \
                src/qt/locale/cts_ru.ts \
                src/qt/locale/cts_sk.ts \
                src/qt/locale/cts_sv.ts \
                src/qt/locale/cts_vi.ts \
                src/qt/locale/cts_zh_CN.ts \
                src/qt/locale/cts_zh_TW.ts
