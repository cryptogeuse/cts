...
The Cts project operates an open contributor model where anyone is
...
The following applies to code changes to the Cts project, and is not to be
confused with overall CTS Network Protocol consensus changes.

Whether a pull request is merged into Cts rests with the project merge
...
Patches that change CTS consensus rules are considerably more involved than
...
Where a patch set proposes to change the CTS consensus, it must have been
...
The project leader is the release manager for each Cts release.
