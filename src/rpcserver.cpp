...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cts features */
        {"cts", "masternode", &masternode, true, true, false},
        {"cts", "listmasternodes", &listmasternodes, true, true, false},
        {"cts", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cts", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cts", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cts", "masternodedebug", &masternodedebug, true, true, false},
        {"cts", "startmasternode", &startmasternode, true, true, false},
        {"cts", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cts", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cts", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cts", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cts", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cts", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cts", "mnbudget", &mnbudget, true, true, false},
        {"cts", "preparebudget", &preparebudget, true, true, false},
        {"cts", "submitbudget", &submitbudget, true, true, false},
        {"cts", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cts", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cts", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cts", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cts", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cts", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cts", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cts", "checkbudgets", &checkbudgets, true, true, false},
        {"cts", "mnsync", &mnsync, true, true, false},
        {"cts", "spork", &spork, true, true, false},
        {"cts", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cts", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ctsd, or the -server option to cts-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cts-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31832/\n";
}
