...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CTS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cts: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cts"), this);
    aboutAction->setStatusTip(tr("Show information about Cts"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CTS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CTS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CTS addresses"));
    ...
    openAction->setStatusTip(tr("Open a CTS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cts help message to get a list with possible CTS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cts client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CTS network", "", count));
}
...
{
    QString strTitle = tr("Cts"); // default title
