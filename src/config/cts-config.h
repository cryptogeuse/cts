/* src/config/cts-config.h.  Generated from cts-config.h.in by configure.  */
/* src/config/cts-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "ctsplatform.cc"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cts Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cts Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cts"
